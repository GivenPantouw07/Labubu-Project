        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              <h2>{contact.navbar_Title}</h2>
            </div>
            <div className="col-12">
              <a href="/">{contact.navbar_subTitle1}</a>
              <a href="/contact">{contact.navbar_subTitle2}</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="footer-row">
          <div className="quick-contact-info">
            ...
            <div className="social-icons">
              <a
                href="https://web.facebook.com/p/Aquarius-Car-Wash-100072266081599/?_rdc=1&_rdr"
                target="_blank"
              ...
              <a
                href="https://x.com/aquariuscarwash?mx=2"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <a
                href="https://www.instagram.com/explore/locations/772508402882252/car-wash-aquarius/"
                target="_blank"
                rel="noopener noreferrer"
              >
              ...
              <a
                href="https://id.linkedin.com/company/aquarius-carwash"
                target="_blank"
                rel="noopener noreferrer"
              >
